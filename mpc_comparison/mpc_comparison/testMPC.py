...
class MPC():
    def __init__(self, generate_c_code: bool, quadrotor: Quadrotor, T_horizon: float, N_horizon: int, code_export_directory : Path=Path('acados_generated_files')):
        ...
        self.pyx_module = self.model_name + '_mpc' + '_c_generated_code' + '.acados_ocp_solver_pyx'
        # print("self.pyx_module: ", self.pyx_module)
        ...
        if self.generate_c_code:
            ...
            try:
                ...
                acados_ocp_solver_pyx = importlib.import_module(self.pyx_module)
